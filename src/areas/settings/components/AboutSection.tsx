      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <Row label={t('about.documentation')} description={t('about.documentationDescription')}>
            <LinkButton label={t('about.open')} href="https://modly3d.app" />
          </Row>
          <Row label={t('about.github')} description={t('about.githubDescription')}>
            <LinkButton label={t('about.open')} href="https://github.com/lightningpixel/modly" />
          </Row>
        </Card>

        <Card>
          <Row label={t('about.discord')} description={t('about.discordDescription')}>
            <LinkButton label={t('about.join')} href="https://discord.gg/FjzjRgweVk" />
          </Row>
          <Row label={t('about.licenses')} description={t('about.licensesDescription')}>
            <LinkButton label={t('about.view')} href="https://github.com/lightningpixel/modly/blob/main/LICENSE" />
          </Row>
        </Card>
